...
class TestGetToneVal(base.BaseTest):
    ...
    def test_get_tone_val_none_8_10(self):
        code, pol = self.model_8_10._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)

    def test_get_tone_val_none_10_10(self):
        code, pol = self.model_10_10._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)

    def test_get_tone_val_none_16_10(self):
        code, pol = self.model_16_10._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)

    def test_get_tone_val_none_8_16(self):
        code, pol = self.model_8_16._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)

    def test_get_tone_val_none_10_16(self):
        code, pol = self.model_10_16._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)

    def test_get_tone_val_none_16_16(self):
        code, pol = self.model_16_16._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)
