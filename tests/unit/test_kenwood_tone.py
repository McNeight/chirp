...
class TestGetToneVal(base.BaseTest):
    ...
    def test_get_tone_val_none(self):
        code, pol = self.model_dec._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)

    def test_get_tone_val_none_dcs_bcd(self):
        code, pol = self.model_dcs_bcd._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)

    def test_get_tone_val_none_tone_bcd(self):
        code, pol = self.model_tone_bcd._get_tone_val(None)
        self.assertIsNone(code)
        self.assertIsNone(pol)
