...
class TestDirectory(base.BaseTest):
    ...
    def test_detect_with_metadata_alias_class(self):
        ...
        with open(fn, "wb") as f:
            ...
            fake_metadata = base64.b64encode(
                json.dumps(
                    {
...
class TestDetectBruteForce(base.BaseTest):
    def test_detect_all(self):
        ...
        for image in test_images:
            ...
            if len(detections) > 1:
                raise Exception("Detection of %s failed: %s" % (image, detections))
    ...
    def test_uniqueness(self):
        ...
        for rclass in directory.DRV_TO_RADIO.values():
            for cls in [rclass] + rclass.ALIASES:
                ...
                self.assertNotIn(fullmodel, directory_models[cls.VENDOR])
        ...
        for vendor, models in sorted(aliases.items()):
            ...
            for model in models:
                ...
                self.assertIn(
                    ...
                    % (alt_vendor, alt_model, vendor, model["model"]),
                )
...
class TestDetectedBy(base.BaseTest):
    ...
    def test_detected_isolation(self):
        ...
        self.assertEqual([SubRadio2], SubRadio1.detected_models(include_self=False))
