...
class TestFileICF(unittest.TestCase):
    ...
    def test_read_icf_data_modern(self):
        ...
        with open(fn, "w", newline="\r\n") as f:
            f.write("12345678\n#Foo=somefoovalue\n#Bar=123\n")
            f.write(
                "0000000020015C70000020800000E4002020202020"
                "20202020202020202020200040810204\n"
            )
            f.write(
                "000000202008102040810204081020408102040810"
    ...
    def test_read_icf_data_old(self):
        ...
        self.assertEqual({"model": b"\x29\x70\x00\x01", "recordsize": 16}, icfdata)
    ...
    def test_read_img_write_icf_modern(self):
        img_file = os.path.join(
            os.path.dirname(__file__), "..", "images", "Icom_ID-31A.img"
        )
        ...
        with open(fn, "w", newline="\r\n"):
            ...
            self.assertIsInstance(directory.get_radio_by_image(fn), id31.ID31Radio)
    ...
    def test_read_img_write_icf_old(self):
        ...
        with open(fn, "w", newline="\r\n"):
            ...
            self.assertIsInstance(directory.get_radio_by_image(fn), ic2820.IC2820Radio)
...
class TestICFUtil(unittest.TestCase):
    ...
    def test_warp_byte_size_symmetric_padded(self):
        ...
        self.assertEqual(ref, bytes(icf.warp_byte_size(stored, obw=6, iskip=4)))
