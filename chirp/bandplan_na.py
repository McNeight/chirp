...
DESC = {"name": "North American Band Plan", "url": "http://www.arrl.org/band-plan"}
...
BANDS_10M = (
    ...
    bandplan.Band((29520000, 29590000), "Repeater Inputs", step_khz=10, mode="FM"),
    bandplan.Band(
        (29610000, 29700000),
        "Repeater Outputs",
        step_khz=10,
...
BANDS_6M = (
    ...
    bandplan.Band((51620000, 51980000), "Repeater outputs A", input_offset=-500000),
    bandplan.Band(
        (51620000, 51680000), "Digital repeater outputs", input_offset=-500000
    ),
    ...
    bandplan.Band((53500000, 53980000), "Repeater outputs C", input_offset=-500000),
...
BANDS_2M = (
    ...
    bandplan.Band((144050000, 144100000), "General CW and weak signals", mode="CW"),
    bandplan.Band((144100000, 144200000), "EME and weak-signal SSB", mode="USB"),
    ...
    bandplan.Band(
        (144900000, 145100000), "Weak signal and FM simplex", mode="FM", step_khz=10
    ),
    bandplan.Band(
        (145100000, 145200000), "Linear translator outputs", input_offset=-600000
    ),
    bandplan.Band(
        (145200000, 145500000),
        "FM repeater outputs",
    ...
    bandplan.Band((146610000, 146970000), "Repeater outputs", input_offset=-600000),
    bandplan.Band((147000000, 147390000), "Repeater outputs", input_offset=600000),
...
BANDS_70CM = (
    ...
    bandplan.Band(
        (438000000, 444000000),
        "ATV repeater input/repeater links",
        input_offset=5000000,
    ),
    bandplan.Band(
        (442000000, 445000000),
        "Repeater input/output (local option)",
        input_offset=5000000,
    ),
    bandplan.Band(
        (445000000, 447000000),
        "Shared by aux and control links, " "repeaters, simplex (local option)",
    ),
    bandplan.Band(
        (447000000, 450000000),
...
BANDS_US_GMRS = (
    bandplan.Band(
        (462550000, 462725000), "GMRS Repeaters", input_offset=5000000, duplex=""
    ),
)
...
BANDS_33CM = (
    ...
    bandplan.Band(
        (909000000, 915000000),
        "Analog/digital Broadband multimedia " "including ATV, DATV and SS",
    ),
    bandplan.Band(
        (915000000, 921000000),
        "Analog/digital Broadband multimedia " "including ATV, DATV and SS",
...
BANDS_23CM = (
    ...
    bandplan.Band(
        (1258000000, 1260000000),
        "Point-to-point links paired with 1246.000-1248.000",
        mode="FM",
    ),
    bandplan.Band((1240000000, 1260000000), "Regional option, FM ATV"),
    bandplan.Band(
        (1260000000, 1270000000), "Satellite uplinks, Experimental, " "Simplex ATV"
    ),
    bandplan.Band(
        (1270000000, 1276000000),
        "FM, digital Repeater inputs " "(Regional option)",
        step_khz=25,
    ),
    bandplan.Band((1276000000, 1282000000), "ATV Channel #3"),
    bandplan.Band(
        (1282000000, 1288000000),
        "FM, digital repeater outputs",
        step_khz=25,
        input_offset=-12000000,
    ),
    bandplan.Band(
        (1288000000, 1294000000), "Various Broadband Experimental, " "Simplex ATV"
    ),
    bandplan.Band(
        (1290000000, 1294000000),
        "FM, digital Repeater outputs " "(Regional option)",
        step_khz=25,
        input_offset=-20000000,
    ),
...
BANDS_13CM = (
    ...
    bandplan.Band(
        (2300000000, 2303000000),
        "Analog & Digital 0.05-1.0 MHz, "
        "including full duplex; paired with 2390-2393",
    ),
    bandplan.Band(
        (2303000000, 2303750000),
        "Analog & Digital <50 kHz; " "paired with 2393 - 2393.750",
    ),
...
GMRS_LOW = [462562500, 462587500, 462612500, 462637500, 462662500, 462687500, 462712500]
GMRS_HHONLY = [
    467562500,
    467587500,
    467612500,
