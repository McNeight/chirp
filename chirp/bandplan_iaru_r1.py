...
BANDS_2100M = (bandplan.Band((135700, 137800), "137 kHz Band", mode="CW"),)
...
BANDS_80M = (
    ...
    bandplan.Band((3600000, 3650000), "All modes, SSB contest preferred", mode="LSB"),
    bandplan.Band((3600000, 3700000), "All modes, SSB QRP", mode="LSB"),
    bandplan.Band((3700000, 3800000), "All modes, SSB contest preferred", mode="LSB"),
...
BANDS_40M = (
    ...
    bandplan.Band((7060000, 7100000), "All modes, SSB contest preferred", mode="LSB"),
    bandplan.Band(
        (7100000, 7130000), "All modes, R1 Emergency Center Of Activity", mode="LSB"
    ),
    bandplan.Band((7130000, 7200000), "All modes, SSB contest preferred", mode="LSB"),
...
BANDS_20M = (
    ...
    bandplan.Band((14099000, 14101000), "IBP, exclusively for beacons", mode="CW"),
    bandplan.Band((14101000, 14112000), "All narrow band modes, digimodes"),
    bandplan.Band((14125000, 14350000), "All modes, SSB contest preferred", mode="USB"),
    bandplan.Band(
        (14300000, 14350000),
        "All modes, Global Emergency center of activity",
        mode="USB",
    ),
)
...
BANDS_17M = (
    ...
    bandplan.Band((18109000, 18111000), "IBP, exclusively for beacons", mode="CW"),
...
BANDS_15M = (
    ...
    bandplan.Band((21149000, 21151000), "IBP, exclusively for beacons", mode="CW"),
...
BANDS_12M = (
    ...
    bandplan.Band((24929000, 24931000), "IBP, exclusively for beacons", mode="CW"),
...
BANDS_10M = (
    ...
    bandplan.Band((28199000, 28201000), "IBP, exclusively for beacons", mode="CW"),
    ...
    bandplan.Band(
        (29520000, 29590000), "All modes, FM repeater inputs", step_khz=10, mode="NFM"
    ),
    bandplan.Band((29600000, 29610000), "FM simplex", step_khz=10, mode="NFM"),
    bandplan.Band(
        (29620000, 29700000),
        "All modes, FM repeater outputs",
        step_khz=10,
        mode="NFM",
        input_offset=-100000,
    ),
...
BANDS_6M = (
    ...
    bandplan.Band(
        (50700000, 50900000), "FM/DV repeater outputs", input_offset=+500000, mode="FM"
    ),
    bandplan.Band((52000000, 54000000), "All modes"),
)

BANDS_4M = (bandplan.Band((70000000, 70500000), "4 Meter Band"),)
...
BANDS_2M = (
    ...
    bandplan.Band(
        (144575000, 145793500), "Repeater outputs", mode="FM", input_offset=-600000
    ),
)
...
BANDS_70CM = (
    ...
    bandplan.Band(
        (434594000, 434981000), "Repeater outputs", mode="FM", input_offset=-16000000
    ),
)
