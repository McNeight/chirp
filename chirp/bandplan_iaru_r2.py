...
BANDS_80M = (
    ...
    bandplan.Band((3700000, 3775000), "All modes, SSB contest preferred", mode="LSB"),
...
BANDS_20M = (
    ...
    bandplan.Band((14112000, 14285000), "All modes, SSB contest preferred", mode="USB"),
...
BANDS_10M = (
    ...
    bandplan.Band((28190000, 28199000), "Regional time shared beacons", mode="CW"),
    bandplan.Band((28199000, 28201000), "IBP, exclusively for beacons", mode="CW"),
    bandplan.Band((28201000, 28225000), "Continuous duty beacons", mode="CW"),
