...
class GMRSV1(bfc.BaofengCommonHT):
    ...
    VALID_BANDS = [(130000000, 180000000), (400000000, 521000000)]
    ...
    def get_settings(self):
        ...
        rs = RadioSetting(
            ...
            RadioSettingValueList(LIST_RTONE, current_index=_mem.settings.rtone),
        )
        basic.append(rs)
        ...
        rs = RadioSetting(
            "settings.rogerrx",
            "Roger Beep (RX)",
            RadioSettingValueList(LIST_OFFAB, current_index=_mem.settings.rogerrx),
        )
        basic.append(rs)
