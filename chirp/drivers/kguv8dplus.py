...
@directory.register
class KGUV8DPlusRadio(chirp_common.CloneModeRadio, chirp_common.ExperimentalRadio):
    """Wouxun KG-UV8D Plus"""
    ...
    def _get_settings(self):
        ...
        rs = RadioSetting(
            ...
            "UHF RX Lower Limit",
            RadioSettingValueInteger(
                300000000, 520000000, self._memobj.uhf_limits.rx_start * 10, 5000
            ),
        )
        ...
        rs = RadioSetting(
            ...
            "UHF RX Upper Limit",
            RadioSettingValueInteger(
                300000000, 520000000, self._memobj.uhf_limits.rx_stop * 10, 5000
            ),
        )
        uhf_lmt_grp.append(rs)
        rs = RadioSetting(
