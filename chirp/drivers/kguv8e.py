...
@directory.register
class KGUV8ERadio(chirp_common.CloneModeRadio, chirp_common.ExperimentalRadio):
    """Wouxun KG-UV8E"""
    ...
    def __init__(self, pipe):
        ...
        self.tone_model = KenwoodToneModel(
            dcs_base=0x2800, pol_mask=0x8000, tone_init=0x0000
        )
    ...
    def match_model(cls, filedata, filename):
        ...
        return (
            cls._file_ident
            in b"kg"
            + filedata[0x426:0x430].replace(b"(", b"").replace(b")", b"").lower()
        )
    ...
    def get_features(self):
        ...
        rf.valid_bands = [
            (134000000, 175000000),  # supports 2m
    ...
    def _get_settings(self):
        ...
        group = RadioSettings(cfg_grp, vfoa_grp, vfob_grp, key_grp, lmt_grp, oem_grp)
        ...
        cfg_grp.append(rs)
        rs = RadioSetting(
            "power_save", "Power save", RadioSettingValueBoolean(_settings.power_save)
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
        ...
        cfg_grp.append(rs)
        rs = RadioSetting(
            "stopwatch", "Stopwatch", RadioSettingValueBoolean(_settings.stopwatch)
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "backlight",
        ...
        cfg_grp.append(rs)
        rs = RadioSetting(
            "ani_sw", "ANI-ID Switch", RadioSettingValueBoolean(_settings.ani_sw)
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "ptt_id",
        ...
        rs = RadioSetting(
            "rpt_mode",
            "Radio Mode",
            RadioSettingValueList(RPTMODE_LIST, current_index=_settings.rpt_mode),
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "rpt_set",
            "Repeater Setting",
            RadioSettingValueList(RPTSET_LIST, current_index=_settings.rpt_set),
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "rpt_spk",
            "Repeater Mode Speaker",
            RadioSettingValueBoolean(_settings.rpt_spk),
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "rpt_ptt", "Repeater PTT", RadioSettingValueBoolean(_settings.rpt_ptt)
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "dtmf_tx_time",
            "DTMF Tx Duration",
            RadioSettingValueList(DTMF_TIMES, current_index=_settings.dtmf_tx_time),
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "dtmf_interval",
            "DTMF Interval",
            RadioSettingValueList(DTMF_TIMES, current_index=_settings.dtmf_interval),
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "alert",
        ...
        rs = RadioSetting(
            "sc_qt",
            "SC-QT",
            RadioSettingValueList(SCQT_LIST, current_index=_settings.sc_qt),
        )
        cfg_grp.append(rs)
        rs = RadioSetting(
            "smuteset",
        ...
        rs = RadioSetting(
            "vfoa.rxfreq",
            "VFO A Rx Frequency",
            RadioSettingValueInteger(134000000, 520000000, _vfoa.rxfreq * 10, 5000),
        )
        vfoa_grp.append(rs)
        rs = RadioSetting(
            "vfoa.txoffset",
        ...
        rs = RadioSetting(
            "vfob.rxfreq",
            "VFO B Rx Frequency",
            RadioSettingValueInteger(134000000, 520000000, _vfob.rxfreq * 10, 5000),
        )
        vfob_grp.append(rs)
        rs = RadioSetting(
            "vfob.txoffset",
        ...
        rs = RadioSetting(
            "pf1_func",
            "PF1 Key function",
            RadioSettingValueList(PF1KEY_LIST, current_index=_settings.pf1_func),
        )
        key_grp.append(rs)
        rs = RadioSetting(
            "pf3_func",
            "PF3 Key function",
            RadioSettingValueList(PF3KEY_LIST, current_index=_settings.pf3_func),
        )
        key_grp.append(rs)
        ...
        rs = RadioSetting(
            ...
            "VHF RX Lower Limit",
            RadioSettingValueInteger(
                134000000, 174997500, self._memobj.vhf_limits.rx_start * 10, 5000
            ),
        )
        ...
        rs = RadioSetting(
            ...
            "VHF RX Upper Limit",
            RadioSettingValueInteger(
                134000000, 174997500, self._memobj.vhf_limits.rx_stop * 10, 5000
            ),
        )
        vhf_lmt_grp.append(rs)
        rs = RadioSetting(
            ...
            "VHF TX Lower Limit",
            RadioSettingValueInteger(
                134000000, 174997500, self._memobj.vhf_limits.tx_start * 10, 5000
            ),
        )
        vhf_lmt_grp.append(rs)
        rs = RadioSetting(
            ...
            "VHF TX Upper Limit",
            RadioSettingValueInteger(
                134000000, 174997500, self._memobj.vhf_limits.tx_stop * 10, 5000
            ),
        )
        vhf_lmt_grp.append(rs)

        rs = RadioSetting(
            "vhf1_limits.rx_start",
            "VHF1 RX Lower Limit",
            RadioSettingValueInteger(
                220000000, 265000000, self._memobj.vhf1_limits.rx_start * 10, 5000
            ),
        )
        ...
        rs = RadioSetting(
            ...
            "VHF1 RX Upper Limit",
            RadioSettingValueInteger(
                220000000, 265000000, self._memobj.vhf1_limits.rx_stop * 10, 5000
            ),
        )
        vhf1_lmt_grp.append(rs)
        rs = RadioSetting(
            "vhf1_limits.tx_start",
            "VHF1 TX Lower Limit",
            RadioSettingValueInteger(
                220000000, 265000000, self._memobj.vhf1_limits.tx_start * 10, 5000
            ),
        )
        vhf1_lmt_grp.append(rs)
        rs = RadioSetting(
            ...
            "VHF1 TX Upper Limit",
            RadioSettingValueInteger(
                220000000, 265000000, self._memobj.vhf1_limits.tx_stop * 10, 5000
            ),
        )
        vhf1_lmt_grp.append(rs)
        ...
        rs = RadioSetting(
            ...
            "UHF RX Lower Limit",
            RadioSettingValueInteger(
                350000000, 520000000, self._memobj.uhf_limits.rx_start * 10, 5000
            ),
        )
        ...
        rs = RadioSetting(
            ...
            "UHF RX Upper Limit",
            RadioSettingValueInteger(
                350000000, 520000000, self._memobj.uhf_limits.rx_stop * 10, 5000
            ),
        )
        uhf_lmt_grp.append(rs)
        rs = RadioSetting(
            ...
            "UHF TX Lower Limit",
            RadioSettingValueInteger(
                400000000, 520000000, self._memobj.uhf_limits.tx_start * 10, 5000
            ),
        )
        uhf_lmt_grp.append(rs)
        rs = RadioSetting(
            ...
            "UHF TX Upper Limit",
            RadioSettingValueInteger(
                400000000, 520000000, self._memobj.uhf_limits.tx_stop * 10, 5000
            ),
        )
        uhf_lmt_grp.append(rs)
